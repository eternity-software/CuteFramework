...
public class ConfirmRequest extends RequestHolder {
    public ConfirmRequest(String code) {
        super(APIMethods.Account.CONFIRM);
        setParams(Pair.make(APIKeys.Account.CODE, code));
    }
